...
namespace ifd {
	...
	void FileDialog::m_renderContent()
	{
		...
		// table view
		if (m_zoom == 1.0f) {
			if (ImGui::BeginTable("##contentTable", 3, ImGuiTableFlags_Resizable | ImGuiTableFlags_Sortable, ImVec2(0, -1))) {
				// header
				ImGui::TableSetupScrollFreeze(3, 1);
				ImGui::TableSetupColumn("Name##filename", ImGuiTableColumnFlags_WidthStretch, -1, 0);
				ImGui::TableSetupColumn("Date modified##filedate", ImGuiTableColumnFlags_WidthStretch, -1, 1);
				ImGui::TableSetupColumn("Size##filesize", ImGuiTableColumnFlags_WidthStretch, -1, 2);
